    ...
    <ul>
      {categories.map((categoryItem) => (
        <li
          ...
          <Link href={categoryItem.link}>{categoryItem.category}</Link>
        </li>
      ))}
    </ul>
  </div>
...
export default function DropdownCategories() {
  return (
    <div className="absolute flex flex-col gap-2 w-[180px] py-3 left-4 bg-[#fafafc] z-40 rounded-lg shadow-[rgba(0,_0,_0,_0.07)_0px_5px_11px_0px]">
